...
jQuery(document).ready(function($){
    ...
    var $services = $('#blogposts');
    var $work = $('#endfixedposition');
    ...
    var waypoints = $services.waypoint(function(direction) {
        if (direction === 'down') {
            $('.sidebar-blog').addClass('fixed-sidebar');
        } else if (direction === 'up') {
            $('.sidebar-blog').removeClass('fixed-sidebar');
        }
    }, {
        offset: 100
    });
    ...
    var waypoints = $work.waypoint(function(direction) {
        if (direction === 'down') {
            $('.sidebar-blog').addClass('bottom-offset').removeClass('fixed-sidebar');
        } else if (direction === 'up') {
            $('.sidebar-blog').addClass('fixed-sidebar').removeClass('bottom-offset');
        }
    }, {
        offset: 650
    });
